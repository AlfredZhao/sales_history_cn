...
(
   ...
   country_total          VARCHAR2(12)   NOT NULL,
...
(
  ...
  PARTITION SALES_2022 VALUES LESS THAN 
    (TO_DATE('2023-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION SALES_2023 VALUES LESS THAN 
    (TO_DATE('2024-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION SALES_2024 VALUES LESS THAN 
    (TO_DATE('2025-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION SALES_2025 VALUES LESS THAN 
    (TO_DATE('2026-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American'))
);
...
(
  PARTITION COSTS_2021 VALUES LESS THAN 
    (TO_DATE('2022-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION COSTS_2022 VALUES LESS THAN 
    (TO_DATE('2023-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION COSTS_2023 VALUES LESS THAN 
    (TO_DATE('2024-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION COSTS_2024 VALUES LESS THAN 
    (TO_DATE('2025-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American')),
  PARTITION COSTS_2025 VALUES LESS THAN 
    (TO_DATE('2026-01-01', 'YYYY-MM-DD', 'NLS_DATE_LANGUAGE = American'))
);
